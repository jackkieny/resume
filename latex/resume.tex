...
\section{References}
    ...
    \begingroup
        \setbox0=\hbox{ \includegraphics[scale=0.1,trim={0 1cm 0cm 0cm}]{latex/icons/mail.png}\hspace{0.1cm} \location{dustin.andrews@cfafranchisee.com} }
        \parbox{\wd0}{\box0}
    \endgroup
    ...
    \endgroup
    \begingroup
        \setbox0=\hbox{ \includegraphics[scale=0.1,trim={0 1.25cm -0.4cm 0cm}]{latex/icons/phone.png}\hspace{0.2cm}\location{+14026161661} }
        \parbox{\wd0}{\box0}
    \endgroup \\
