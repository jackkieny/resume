...
\section{References}
    ...
    % Reference 1
    \href{https://www.linkedin.com/in/dustin-andrews-4056b232/}{\textbf{Dustin Andrews}, Owner/Operator, Chick-fil-A 48th and O Street
    \begingroup
        \setbox0=\hbox{
            \includegraphics[scale=0.1,trim={0 1cm 0cm 0cm}]{latex/icons/mail.png}\hspace{0.3cm} dustin.andrews@cfafranchisee.com
        }
        \parbox{\wd0}{\box0}
    \endgroup
